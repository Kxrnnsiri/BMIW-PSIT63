...
def profile():
    ...
    Label(profile, text="Username    "+"     "*4 ,font ="Mali 12", bg="#660000",fg = "#FFFFFF").pack(side=TOP,pady=0,padx=10)
    name = Entry(profile, font="consolas 15", bg="#FFFFFF",fg="#660000")
    name.pack(side=TOP,pady=0,padx=60)
    name1 = name.get()
    Label(profile, text="Password"+"     "*5 , font="Mali 12", bg="#660000", fg="#FFFFFF").pack(side=TOP, pady=0, padx=10)
