...
def detailLeg(check):
    def create_pose_1(img):
        ...
        วิธีทำ : 
            ...
            2. เคลื่อนไหวโดยการค่อย ๆ แทงเข่าไปด้านข้าง โดยที่เท้ายังตรีงอยู่กับที่
    ...
    def create_pose_5(img):
        ...
        วิธีทำ :
            ...
            2. ยกขาทั้งสองข้างขึ้นในลักษณะเหยียดตรง เท้าชี้ขึ้นบนเพดาน เกร็งขาค้างไว้สักครู่หนึ่งแล้วค่อย ๆ ลดขาลงช้า ๆ ให้กลับเข้าสู่ท่าปกติ
