...
def detailBottom(check):
    ...
    def create_pose_2(img):
        ...
        วิธีทำ :
            ...
            3. ยืดตัว ก้าวขาซ้ายไปด้าน เฉียงออกไปทางซ้าย ย่อเข่าลง เอนตัวไปด้านหน้าเล็กน้อย
    ...
    def create_pose_3(img):
        ...
        อุปกรณ์ : ไม่มี
        วิธีทำ :
            1. ยืนตัวตรง วางเท้าให้ห่างประมาณสองช่วงแขน ปลายเท้าชี้ออกไปข้างนอกให้ตั้งฉากกับระดับสายตา
            มือทั้งสองข้างเหยียดไว้ด้านหน้าระดับอก
    ...
    def create_pose_4(img):
        ...
        อุปกรณ์ : ไม่มี
        วิธีทำ :
            1. นอนหงายกับพื้น ยืดตัวตรง วางแขนไว้ข้างลำตัว จากนั้นชันเข่าขึ้น
            แยกเท้าให้ห่างเท่ากับความกว้างของสะโพก
...
# หน้าต่าง window หลัก
    window = Tk()
    window.title('BMIW: Bottom Workout')
